...
Como podemos observar las variables `gender`, `class`, `embarked` afectan a la supervivencia tras el hundimiento del Titanic. Las variables `age`, `sibsp` y `parch` no parecen afectar a la supervivencia. Además en muchos tests parece que la aproximación parece no ser del todo correcta.
