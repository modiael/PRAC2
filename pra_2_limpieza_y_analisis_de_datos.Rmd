...
# ds$country = as.factor(ds$country) # Possee NAs que vamos a imputar, por lo tanto realizamos el factor después de tratar sus valores.
...
ds[c(index_is_na_age),]
```
Para la variable **country**, lugar de procedencia del pasajero se procede a sustituir los NAs por el valor **UNKNOWN**.
```{r}
ds[c(which(is.na(ds$country))),]$country <- "UNKNOWN"
